...
const PlaceOrder = () => {
    ...
    const {getTotalCartAmount, token, food_list, cartData, cartItems, url} = useContext(StoreContext);
    ...
    return (
        <form onSubmit={placeOrder} className="place-order">
            <div className='place-order-left'>
                ...
                <div className="multi-fields">
                    <input required name='zipcode' onChange={onChangeHandler} value={data.zipcode} type="text" placeholder='Código ZIP' />
                ...
                <div className='place-order-right'>
                    <div className='cart-total'>
                        ...
                        <button type='submit'>PROCEDA A PAGAR</button>
                    </div>
                </div>
        </form>
    )
